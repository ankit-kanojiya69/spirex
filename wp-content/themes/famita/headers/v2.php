<header id="apus-header" class="apus-header header-v1 header-v2 hidden-sm hidden-xs" role="banner">
    <?php if ( is_active_sidebar( 'sidebar-topbar-left' ) || is_active_sidebar( 'sidebar-topbar-center' ) || is_active_sidebar( 'sidebar-topbar-right' )) { ?>
            ...
            <div class="header-full">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <?php } ?>
                        <?php if ( is_active_sidebar( 'sidebar-topbar-center' ) ) { ?>
                            <div class="col-md-4 text-center">
                                <?php dynamic_sidebar( 'sidebar-topbar-center' ); ?>
                            </div>
                        <?php } ?>
                            ...
                            <div class="pull-right">
                                ...
                                <?php } else { ?>
                                    <ul class="topmenu-menu-line">
                                        <li><a class="login" href="<?php echo esc_url( get_permalink( get_option('woocommerce_myaccount_page_id') ) ); ?>" title="<?php esc_attr_e('Sign in','famita'); ?>"><?php esc_html_e('Login', 'famita'); ?></a></li>
                                        <li class="space">/</li>
